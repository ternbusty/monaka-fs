//! Benchmark: All VFS Methods Comparison
//!
//! Measures sequential write, sequential read, and random read performance.
//! Used for comparing: static compose, host trait, and RPC methods.
