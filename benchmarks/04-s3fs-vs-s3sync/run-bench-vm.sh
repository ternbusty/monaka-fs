#!/bin/bash
# Benchmark 04: s3fs-fuse vs Halycon S3 Sync (VM version)
...
echo "=========================================="
echo "  Benchmark 04: s3fs vs Halycon (E2E)"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "  Running: Halycon S3 Sync benchmark"
echo "=========================================="
echo ""
...
echo "      Halycon: in-memory write + async S3 sync"
