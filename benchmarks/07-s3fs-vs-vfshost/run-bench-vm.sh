#!/bin/bash
# Benchmark 07: s3fs-fuse vs vfs-host S3 Sync (VM version) - BATCH MODE
...
echo "=========================================="
echo "  Benchmark 07: s3fs vs vfs-host (BATCH)"
echo "=========================================="
echo ""
echo "Measuring: write start → S3 arrival"
echo "Sync Mode: BATCH (deferred persistence)"
echo ""
...
# ==========================================
#   vfs-host Benchmark (BATCH mode)
# ==========================================
echo ""
echo "=========================================="
echo "  Running: vfs-host S3 Sync (BATCH)"
echo "=========================================="
echo ""
...
echo "  vfs-host BATCH: in-memory write + deferred S3 sync (5s interval)"
